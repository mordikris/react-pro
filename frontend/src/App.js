...
import ForgetPsdScreen from './screen/ForgetPsdScreen';
  ...
  return (
    <BrowserRouter>
      <div
        ...
        <header>
          <Navbar bg="dark" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand>Alliabualli </Navbar.Brand>
              </LinkContainer>
        ...
        <main>
          <Container className='mt-3'>
            <Routes>
              ...
              <Route path="/forgetPsd" element={<ForgetPsdScreen />} />
        ...
        <footer>
          <div className='text-center'>2023 All rights reserved to the best Mordechay  </div>
        </footer>
      </div>
    </BrowserRouter>
  );
